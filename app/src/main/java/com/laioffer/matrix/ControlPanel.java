...
public class ControlPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // location tracker
        final LocationTracker mLocationTracker = new LocationTracker(this); //this是context, getSystemSupport
                ...
                new DrawerLayout.DrawerListener() {
                    ...
                    public void onDrawerOpened(@NonNull View drawerView) {
                        ...
                        if (Config.username == null) {
                            ...
                            location_textview.setText("Lat=" + new DecimalFormat(".##").format(latitude) + ",Lon=" + new DecimalFormat(".##").format(longitude));
                        }
                    }
